...
@section('content')
    ...
    <div class="inner-hero">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                     <div class="inner-text">  <h4> Show </h4> </div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="cc-list-box">
            <div class="col-lg-6">
                <div class="cibb-main">
                    ...
                    <p> <span>  30 finalist </span> from each <span> 11 different categories </span> will be chosen through nation wide auditions to compete in Grand Finale </p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p> Online facilities are available on this website.  <br/>
                        Offline facilities are also available and the interested one can apply at our corporate office at the address given in the website. <br/>
                    ...
                    <ul class="dd-list">
                        <li class="dd-item"> Applicant should be an Indian Citizen including NRI and must be Male or Female gender by birth with Sound Mind. </li>
                        <li class="dd-item"> Minimum age to participate is 16 to 36 according to category. </li>
                        <li class="dd-item"> Relaxation in age as a special case will be subject to approval from Jury. </li>
                        <li class="dd-item"> Applicant must have age proof and should provide the same at the time of registration. </li>
                        <li class="dd-item"> Valid Photo ID such as Aadhaar Card, Passport, Driving License etc. is mandatory for age & address. </li>
                        <li class="dd-item"> If you are living at different address as mentioned in ID proof, than you are required to give the address of the property where you are staying.
                        </li>
                        <li class="dd-item"> However, non-residential Indians are also eligible, if you are born in India or abroad, either of the parents should be from India.
                        </li>
                        <li class="dd-item"> Participants must have minimum 5’4″ height for females & 5’8” height for males without footwear for the Beauty Pageant Ramp Show.
                        </li>
                    </ul>
                    ...
                    <ul class="dd-list">
                        <li class="dd-item"> Step 1: Keep 4 pictures ready : close-up, mid-length, full length & no make-up. </li>
                        <li class="dd-item"> Step  2 : Videos of the Talent to be uploaded by you. </li>
                        <li class="dd-item"> Step 3 : Keep the scanned copies of the documents mentioned below for Eligibility Proof: </li>
                        <p> A. Nationality Proof / Address Proof / Date of Birth :  Aadhar Card or Passport Copy or Driving License. In the case of OCI applicant, we will require an oci card.  </p>
                        <li class="dd-item"> Step 4 : Sign In with your email ID or Mobile Number </li>
                        <li class="dd-item"> VStep 5 : Upload 2 separate audition videos : Introduction Video & Ramp walk Video. Please note each video limit should be of 60 seconds only. </li>
                        <li class="dd-item"> Step 6 : Fill in all your credentials, your Instagram handle & your physical attributes along with your contact details. All fields are mandatory.
                        </li>
                        <li class="dd-item"> Step 7 : Upload your pictures & necessary documents as mentioned in the first three steps.
                        </li>
                        <li class="dd-item"> Step 8 : One time registration fee Rs 1999 inclusive of all taxes.  Register on the payment link with the same email ID as your application form.
                        </li>
                        <li class="dd-item"> Step 9 : Enter the unique code received on your registered email id / mobile no. </li>
                        <li class="dd-item"> Step 10 : Once all the fields are completed, click on accept T&Cs & submit the form. </li>
                        <li class="dd-item"> Step 11 : You will receive an automated email upon successful submission of the form.  </li>
                    ...
                    <div class="enquire-box">
                        ...
                        <div class="form-box">
                            <div class="form-list">
                                ...
                                <div class="form-item mt-md-4">
                                    <label for=""> Category Applying For   </label>
                                    <input type="text" />
                                </div>
                            </div>
                            <div class="form-button py-3" > <a href="#!"> Register Now  </a> </div>
                        </div>
                    </div>
            ...
            <div class="deco-img">
                ...
                <div class="deco-right">  
                    ...
                    <p> Each finalist will undergo an elite preparation program, crafted
                        ...
                        training on ramp walk, posture & physical appeal, dress trials, fitness sessions, make-up, dental & hair care, stage presence and self-confidence.  </p>
                </div>
            </div>
     </div>
    <!--============================== Content End ==============================-->
                    ...
                    <div class="cta">  
                        ...
                        <div class="button"> Download PDF Now  
                            <svg xmlns="http://www.w3.org/2000/svg" width="106" height="106" viewBox="0 0 106 106" fill="none">
                                <path d="M34.7476 70.5501C24.8495 60.652 24.8495 44.6465 34.7476 34.7485C44.6457 24.8504 60.6511 24.8504 70.5492 34.7485C80.4473 44.6465 80.4473 60.652 70.5492 70.5501C60.6511 80.4482 44.6457 80.4482 34.7476 70.5501ZM68.4433 36.8544C59.7035 28.1146 45.5934 28.1146 36.8536 36.8544C28.1138 45.5942 28.1138 59.7043 36.8536 68.4441C45.5934 77.1839 59.7035 77.1839 68.4433 68.4441C77.1831 59.7043 77.1831 45.5942 68.4433 36.8544Z" fill="white"/>
                                <path d="M59.5977 63.1791L59.5977 45.6995L42.118 45.6995L42.118 42.7511L62.546 42.7511L62.546 63.1791L59.5977 63.1791Z" fill="white"/>
                                <path d="M60.0195 43.1729L62.1255 45.2788L44.2247 63.1796L42.1187 61.0737L60.0195 43.1729Z" fill="white"/>
                              </svg>
                        </div>
                    </div>
                </div>
